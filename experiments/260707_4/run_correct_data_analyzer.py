...
from train import HoloEvNetBaseV3  # モデル定義をインポート
...
if __name__ == "__main__":
    ...
    model_file = current_dir / "best_model_ch4.pth"
    test_data_folder = current_dir / "processed_data" / "test"
    output_json = current_dir / "result" / "prediction_analysis.json"
    
    # 今回試したチャネル数に合わせてモデルを初期化してラッパーに引き渡す
    model_inst = HoloEvNetBaseV3(in_channels=4, num_classes=50)
